 ...
 * @author Paige
 *
 *The Point class implements the Comparable interface.
 * 
 *It's compareTo() method compares the x or y coordinates of two points. In case tow points have the 
 *same value along one coordinate, compare the values of the other coordinate. 
 */
...
public class Point implements Comparable<Point>
{
	...
	public int compareTo(Point q)
	{
		...
		if ((Point.xORy == true && (this.x < q.x || (this.x == q.x && this.y < q.y))) 
			|| (Point.xORy == false && (this.y < q.y || (this.y == q.y && this.x < q.x))))
			return -1;
		//if they are equal
